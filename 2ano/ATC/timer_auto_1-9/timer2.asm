...
;--------------------------------------------------------
	.area DSEG    (DATA)
Ltimer2.main$zero_nine$1_1$7==.
_main_zero_nine_65537_7:
	.ds 10
;--------------------------------------------------------
...
;------------------------------------------------------------
	G$sdelay$0$0 ==.
	C$timer2.c$4$0_0$3 ==.
;	C:\2ano\ATC\timer_auto_1-9\timer2.c:4: void sdelay(int time)
;	-----------------------------------------
;	 function sdelay
;	-----------------------------------------
_sdelay:
	...
	mov	r7,dph
	C$timer2.c$7$2_0$3 ==.
;	C:\2ano\ATC\timer_auto_1-9\timer2.c:7: for (int i = 0; i < time; i++)
	mov	r4,#0x00
	mov	r5,#0x00
00107$:
	clr	c
	...
	jnc	00109$
	C$timer2.c$9$2_0$3 ==.
;	C:\2ano\ATC\timer_auto_1-9\timer2.c:9: for (int j = 0; j < 100; j++); // delay 1 sec
	mov	r2,#0x00
	mov	r3,#0x00
00104$:
	clr	c
...
00109$:
	C$timer2.c$11$2_0$3 ==.
;	C:\2ano\ATC\timer_auto_1-9\timer2.c:11: }
	C$timer2.c$11$2_0$3 ==.
	XG$sdelay$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;zero_nine                 Allocated with name '_main_zero_nine_65537_7'
;i                         Allocated to registers r6 r7 
;j                         Allocated to registers r4 r5 
;------------------------------------------------------------
	G$main$0$0 ==.
	C$timer2.c$16$2_0$6 ==.
;	C:\2ano\ATC\timer_auto_1-9\timer2.c:16: void main()
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$timer2.c$19$1_0$6 ==.
;	C:\2ano\ATC\timer_auto_1-9\timer2.c:19: PCA0MD = 0x00;
	mov	_PCA0MD,#0x00
	C$timer2.c$20$1_0$6 ==.
;	C:\2ano\ATC\timer_auto_1-9\timer2.c:20: XBR1 = 0x40;
	mov	_XBR1,#0x40
	C$timer2.c$25$2_0$7 ==.
;	C:\2ano\ATC\timer_auto_1-9\timer2.c:25: char zero_nine[] = {0xc0, 0xf9, 0xa4, 0xb0, 0x99, 0x92, 0x82, 0xf8, 0x80, 0x90};
	mov	_main_zero_nine_65537_7,#0xc0
	mov	(_main_zero_nine_65537_7 + 0x0001),#0xf9
	mov	(_main_zero_nine_65537_7 + 0x0002),#0xa4
	mov	(_main_zero_nine_65537_7 + 0x0003),#0xb0
	mov	(_main_zero_nine_65537_7 + 0x0004),#0x99
	mov	(_main_zero_nine_65537_7 + 0x0005),#0x92
	mov	(_main_zero_nine_65537_7 + 0x0006),#0x82
	mov	(_main_zero_nine_65537_7 + 0x0007),#0xf8
	mov	(_main_zero_nine_65537_7 + 0x0008),#0x80
	mov	(_main_zero_nine_65537_7 + 0x0009),#0x90
	C$timer2.c$27$1_1$7 ==.
;	C:\2ano\ATC\timer_auto_1-9\timer2.c:27: while (1)
00110$:
	C$timer2.c$29$2_1$8 ==.
;	C:\2ano\ATC\timer_auto_1-9\timer2.c:29: P2 = 0xC0;
	mov	_P2,#0xc0
	C$timer2.c$30$2_1$8 ==.
;	C:\2ano\ATC\timer_auto_1-9\timer2.c:30: if (P0_7 == 0)
	jnb	_P0_7,00149$
	ljmp	00107$
00149$:
	C$timer2.c$32$1_1$6 ==.
;	C:\2ano\ATC\timer_auto_1-9\timer2.c:32: for (int i = 0; i < 10; i++)
	mov	r6,#0x00
	mov	r7,#0x00
00116$:
	clr	c
	...
	jnc	00110$
	C$timer2.c$34$1_1$6 ==.
;	C:\2ano\ATC\timer_auto_1-9\timer2.c:34: for (int j = 0; j <= 10; j++)
	mov	r4,#0x00
	mov	r5,#0x00
00113$:
	clr	c
	...
	xrl	b,#0x80
	subb	a,b
	C$timer2.c$36$7_1$13 ==.
;	C:\2ano\ATC\timer_auto_1-9\timer2.c:36: if (j < 10)
	jc	00117$
	mov	a,r4
	subb	a,#0x0a
	mov	a,r5
	...
	subb	a,#0x80
	jnc	00102$
	C$timer2.c$38$8_1$14 ==.
;	C:\2ano\ATC\timer_auto_1-9\timer2.c:38: P2 = zero_nine[j];
	mov	a,r4
	add	a,#_main_zero_nine_65537_7
	mov	r1,a
	mov	_P2,@r1
	C$timer2.c$39$8_1$14 ==.
;	C:\2ano\ATC\timer_auto_1-9\timer2.c:39: sdelay(1000);
	mov	dptr,#0x03e8
	push	ar7
	push	ar6
	push	ar5
	...
	sjmp	00114$
00102$:
	C$timer2.c$43$8_1$15 ==.
;	C:\2ano\ATC\timer_auto_1-9\timer2.c:43: P2 = zero_nine[i + 1];
	mov	ar3,r6
	mov	a,r3
	inc	a
	add	a,#_main_zero_nine_65537_7
	mov	r1,a
	mov	_P2,@r1
	C$timer2.c$44$8_1$15 ==.
;	C:\2ano\ATC\timer_auto_1-9\timer2.c:44: sdelay(500);
	mov	dptr,#0x01f4
	push	ar7
	push	ar6
	push	ar5
...
00107$:
	C$timer2.c$50$2_1$8 ==.
;	C:\2ano\ATC\timer_auto_1-9\timer2.c:50: P2 = 0xFF;
	mov	_P2,#0xff
	ljmp	00110$
	C$timer2.c$52$1_1$6 ==.
;	C:\2ano\ATC\timer_auto_1-9\timer2.c:52: }
	C$timer2.c$52$1_1$6 ==.
	XG$main$0$0 ==.
	ret
	.area CSEG    (CODE)
