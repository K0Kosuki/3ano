M:ATCPro
F:G$iniciar_sysclock$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$iniciar_timer$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$iniciar_interrupcoes$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$iniciar_timer0$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$iniciar_timer1$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$timer1_overflow$0_0$0({2}DF,SV:S),C,0,0,1,3,0
F:G$timer0_overflow$0_0$0({2}DF,SV:S),C,0,0,1,1,0
F:G$start$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$reset$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$split_on$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$split_off$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$stop_on$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$stop_off$0_0$0({2}DF,SV:S),C,0,0,0,0,0
F:G$main$0_0$0({2}DF,SV:S),C,0,0,0,0,0
S:G$d$0_0$0({2}SI:U),E,0,0
S:G$u$0_0$0({2}SI:U),E,0,0
S:G$U$0_0$0({2}SI:U),E,0,0
S:G$D$0_0$0({2}SI:U),E,0,0
S:G$aux$0_0$0({2}SI:U),E,0,0
S:G$aux1$0_0$0({2}SI:U),E,0,0
S:G$estado$0_0$0({2}SI:U),E,0,0
S:G$split$0_0$0({2}SI:U),E,0,0
...
S:G$iniciar_sysclock$0_0$0({2}DF,SV:S),C,0,0
S:G$iniciar_timer$0_0$0({2}DF,SV:S),C,0,0
S:G$iniciar_interrupcoes$0_0$0({2}DF,SV:S),C,0,0
S:G$iniciar_timer0$0_0$0({2}DF,SV:S),C,0,0
S:G$iniciar_timer1$0_0$0({2}DF,SV:S),C,0,0
S:G$timer1_overflow$0_0$0({2}DF,SV:S),C,0,0
S:G$timer0_overflow$0_0$0({2}DF,SV:S),C,0,0
S:G$start$0_0$0({2}DF,SV:S),C,0,0
S:G$reset$0_0$0({2}DF,SV:S),C,0,0
S:G$split_on$0_0$0({2}DF,SV:S),C,0,0
S:G$split_off$0_0$0({2}DF,SV:S),C,0,0
S:G$stop_on$0_0$0({2}DF,SV:S),C,0,0
S:G$stop_off$0_0$0({2}DF,SV:S),C,0,0
S:G$main$0_0$0({2}DF,SV:S),C,0,0
S:G$sequencia$0_0$0({10}DA10d,SC:U),D,0,0
