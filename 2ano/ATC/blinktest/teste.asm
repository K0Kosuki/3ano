...
;--------------------------------------------------------
	.area DSEG    (DATA)
Lteste.main$zero_nine$1_1$8==.
_main_zero_nine_65537_8:
	.ds 10
;--------------------------------------------------------
...
;------------------------------------------------------------
	G$sdelay$0$0 ==.
	C$teste.c$4$0_0$3 ==.
;	E:\2ano\ATC\blinktest\teste.c:4: void sdelay(int time){
;	-----------------------------------------
;	 function sdelay
;	-----------------------------------------
_sdelay:
	...
	mov	r7,dph
	C$teste.c$6$2_0$3 ==.
;	E:\2ano\ATC\blinktest\teste.c:6: for(int i=0;i<time;i++){
	mov	r4,#0x00
	mov	r5,#0x00
00107$:
	clr	c
	...
	jnc	00109$
	C$teste.c$8$2_0$3 ==.
;	E:\2ano\ATC\blinktest\teste.c:8: for(int j=0;j<10;j++); //0.15seg? but y?
	mov	r2,#0x00
	mov	r3,#0x00
00104$:
	clr	c
...
00109$:
	C$teste.c$10$2_0$3 ==.
;	E:\2ano\ATC\blinktest\teste.c:10: }
	C$teste.c$10$2_0$3 ==.
	XG$sdelay$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
;zero_nine                 Allocated with name '_main_zero_nine_65537_8'
;i                         Allocated to registers r6 r7 
;------------------------------------------------------------
	G$main$0$0 ==.
	C$teste.c$15$2_0$7 ==.
;	E:\2ano\ATC\blinktest\teste.c:15: void main (void) {
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$teste.c$17$1_0$7 ==.
;	E:\2ano\ATC\blinktest\teste.c:17: PCA0MD = 0x00;		
	mov	_PCA0MD,#0x00
	C$teste.c$18$1_0$7 ==.
;	E:\2ano\ATC\blinktest\teste.c:18: XBR1 = 0x40;				
	mov	_XBR1,#0x40
	C$teste.c$21$2_0$8 ==.
;	E:\2ano\ATC\blinktest\teste.c:21: char zero_nine[]={0xc0,0xf9,0xa4,0xb0,0x99,0x92,0x82,0xf8,0x80,0x90} ;    
	mov	_main_zero_nine_65537_8,#0xc0
	mov	(_main_zero_nine_65537_8 + 0x0001),#0xf9
	mov	(_main_zero_nine_65537_8 + 0x0002),#0xa4
	mov	(_main_zero_nine_65537_8 + 0x0003),#0xb0
	mov	(_main_zero_nine_65537_8 + 0x0004),#0x99
	mov	(_main_zero_nine_65537_8 + 0x0005),#0x92
	mov	(_main_zero_nine_65537_8 + 0x0006),#0x82
	mov	(_main_zero_nine_65537_8 + 0x0007),#0xf8
	mov	(_main_zero_nine_65537_8 + 0x0008),#0x80
	mov	(_main_zero_nine_65537_8 + 0x0009),#0x90
	C$teste.c$25$1_1$7 ==.
;	E:\2ano\ATC\blinktest\teste.c:25: for(int i=0;i<10;i++)
00112$:
	mov	r6,#0x00
	mov	r7,#0x00
00106$:
	...
	jnc	00112$
	C$teste.c$27$4_1$11 ==.
;	E:\2ano\ATC\blinktest\teste.c:27: P2=zero_nine[i]; 
	mov	a,r6
	add	a,#_main_zero_nine_65537_8
	mov	r1,a
	mov	_P2,@r1
	C$teste.c$28$4_1$11 ==.
;	E:\2ano\ATC\blinktest\teste.c:28: sdelay(1000);
	mov	dptr,#0x03e8
	push	ar7
	push	ar6
	lcall	_sdelay
...
;	E:\2ano\ATC\blinktest\teste.c:25: for(int i=0;i<10;i++)
	...
	sjmp	00106$
	C$teste.c$35$1_1$7 ==.
;	E:\2ano\ATC\blinktest\teste.c:35: }
	C$teste.c$35$1_1$7 ==.
	XG$main$0$0 ==.
	ret
	.area CSEG    (CODE)
