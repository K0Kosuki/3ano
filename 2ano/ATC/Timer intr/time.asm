...
;--------------------------------------------------------
	...
	C$time.c$2$1_0$4 ==.
;	C:\2ano\ATC\Timer intr\time.c:2: volatile char c = 0;
	mov	_c,#0x00
	.area GSFINAL (CODE)
...
;------------------------------------------------------------
	G$config$0$0 ==.
	C$time.c$3$0_0$1 ==.
;	C:\2ano\ATC\Timer intr\time.c:3: void config()
;	-----------------------------------------
;	 function config
;	-----------------------------------------
_config:
	...
	ar0 = 0x00
	C$time.c$6$1_0$1 ==.
;	C:\2ano\ATC\Timer intr\time.c:6: PCA0MD = 0x00;
	mov	_PCA0MD,#0x00
	C$time.c$7$1_0$1 ==.
;	C:\2ano\ATC\Timer intr\time.c:7: XBR1 = 0x40;
	mov	_XBR1,#0x40
	C$time.c$9$1_0$1 ==.
;	C:\2ano\ATC\Timer intr\time.c:9: CLKSEL = 0X03; //
	mov	_CLKSEL,#0x03
	C$time.c$10$1_0$1 ==.
;	C:\2ano\ATC\Timer intr\time.c:10: CKCON = 0x02;  // divide por 48 assim T =1us
	mov	_CKCON,#0x02
	C$time.c$11$1_0$1 ==.
;	C:\2ano\ATC\Timer intr\time.c:11: TMOD = 0x10;   // TIME1 16bit manuelmente
	mov	_TMOD,#0x10
	C$time.c$12$1_0$1 ==.
;	C:\2ano\ATC\Timer intr\time.c:12: IE = 0X88;
	mov	_IE,#0x88
	C$time.c$13$1_0$1 ==.
;	C:\2ano\ATC\Timer intr\time.c:13: TR1 = 1;
;	assignBit
	setb	_TR1
	C$time.c$14$1_0$1 ==.
;	C:\2ano\ATC\Timer intr\time.c:14: TH1 = (-50000) >> 8;
	mov	_TH1,#0x3c
	C$time.c$15$1_0$1 ==.
;	C:\2ano\ATC\Timer intr\time.c:15: TL1 = -50000;
	mov	_TL1,#0xb0
	C$time.c$16$1_0$1 ==.
;	C:\2ano\ATC\Timer intr\time.c:16: }
	C$time.c$16$1_0$1 ==.
	XG$config$0$0 ==.
	ret
;------------------------------------------------------------
;Allocation info for local variables in function 'interrput'
;------------------------------------------------------------
	G$interrput$0$0 ==.
	C$time.c$18$1_0$2 ==.
;	C:\2ano\ATC\Timer intr\time.c:18: void interrput()
;	-----------------------------------------
;	 function interrput
;	-----------------------------------------
_interrput:
	C$time.c$21$1_0$2 ==.
;	C:\2ano\ATC\Timer intr\time.c:21: if (c == 20)
	mov	a,#0x14
	cjne	a,_c,00102$
	C$time.c$23$2_0$3 ==.
;	C:\2ano\ATC\Timer intr\time.c:23: P2_7 =!P2_7;
	cpl	_P2_7
	C$time.c$24$2_0$3 ==.
;	C:\2ano\ATC\Timer intr\time.c:24: c = 0;
	mov	_c,#0x00
00102$:
	C$time.c$26$1_0$2 ==.
;	C:\2ano\ATC\Timer intr\time.c:26: TH1 = (-50000) >> 8;
	mov	_TH1,#0x3c
	C$time.c$27$1_0$2 ==.
;	C:\2ano\ATC\Timer intr\time.c:27: TL1 = -50000;
	mov	_TL1,#0xb0
	C$time.c$28$1_0$2 ==.
;	C:\2ano\ATC\Timer intr\time.c:28: c++;
	mov	a,_c
	inc	a
	mov	_c,a
	C$time.c$29$1_0$2 ==.
;	C:\2ano\ATC\Timer intr\time.c:29: }
	C$time.c$29$1_0$2 ==.
	XG$interrput$0$0 ==.
	ret
;------------------------------------------------------------
...
;------------------------------------------------------------
	G$main$0$0 ==.
	C$time.c$31$1_0$4 ==.
;	C:\2ano\ATC\Timer intr\time.c:31: void main()
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$time.c$33$1_0$4 ==.
;	C:\2ano\ATC\Timer intr\time.c:33: config();
	lcall	_config
	C$time.c$34$1_0$4 ==.
;	C:\2ano\ATC\Timer intr\time.c:34: while (1)
00102$:
	sjmp	00102$
	C$time.c$36$1_0$4 ==.
;	C:\2ano\ATC\Timer intr\time.c:36: }
	C$time.c$36$1_0$4 ==.
	XG$main$0$0 ==.
	ret
	.area CSEG    (CODE)
