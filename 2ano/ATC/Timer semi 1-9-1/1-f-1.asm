...
;--------------------------------------------------------
	.area DSEG    (DATA)
L1_f_1.main$zero_F$1_1$8==.
_main_zero_F_65537_8:
	.ds 17
;--------------------------------------------------------
...
;------------------------------------------------------------
	G$delay$0$0 ==.
	C$1_f_1.c$3$0_0$3 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1-f-1.c:3: void delay(int time)
;	-----------------------------------------
;	 function delay
;	-----------------------------------------
_delay:
	...
	mov	r7,dph
	C$1_f_1.c$6$2_0$3 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1-f-1.c:6: for (int i = 0; i < time; i++)
	mov	r4,#0x00
	mov	r5,#0x00
00107$:
	clr	c
	...
	jnc	00109$
	C$1_f_1.c$8$2_0$3 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1-f-1.c:8: for (int j = 0; j < 50; j++)
	mov	r2,#0x00
	mov	r3,#0x00
00104$:
	clr	c
...
00109$:
	C$1_f_1.c$11$2_0$3 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1-f-1.c:11: }
	C$1_f_1.c$11$2_0$3 ==.
	XG$delay$0$0 ==.
	ret
;------------------------------------------------------------
...
;zero_F                    Allocated with name '_main_zero_F_65537_8'
;------------------------------------------------------------
	G$main$0$0 ==.
	C$1_f_1.c$13$2_0$7 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1-f-1.c:13: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	C$1_f_1.c$15$1_0$7 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1-f-1.c:15: PCA0MD = 0x00;
	mov	_PCA0MD,#0x00
	C$1_f_1.c$16$1_0$7 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1-f-1.c:16: XBR1 = 0x40;
	mov	_XBR1,#0x40
	C$1_f_1.c$17$1_0$7 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1-f-1.c:17: P2 = 0Xc0;
	mov	_P2,#0xc0
	C$1_f_1.c$19$2_0$8 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1-f-1.c:19: char zero_F[] = {0xc0, 0xf9, 0xa4, 0xb0, 0x99, 0x92, 0x82, 0xf8, 0x80, 0x90, 0x88, 0x83, 0xc6, 0xa1, 0x86, 0x8e, 0x7f};
	mov	_main_zero_F_65537_8,#0xc0
	mov	(_main_zero_F_65537_8 + 0x0001),#0xf9
	mov	(_main_zero_F_65537_8 + 0x0002),#0xa4
	mov	(_main_zero_F_65537_8 + 0x0003),#0xb0
	mov	(_main_zero_F_65537_8 + 0x0004),#0x99
	mov	(_main_zero_F_65537_8 + 0x0005),#0x92
	mov	(_main_zero_F_65537_8 + 0x0006),#0x82
	mov	(_main_zero_F_65537_8 + 0x0007),#0xf8
	mov	(_main_zero_F_65537_8 + 0x0008),#0x80
	mov	(_main_zero_F_65537_8 + 0x0009),#0x90
	mov	(_main_zero_F_65537_8 + 0x000a),#0x88
	mov	(_main_zero_F_65537_8 + 0x000b),#0x83
	mov	(_main_zero_F_65537_8 + 0x000c),#0xc6
	mov	(_main_zero_F_65537_8 + 0x000d),#0xa1
	mov	(_main_zero_F_65537_8 + 0x000e),#0x86
	mov	(_main_zero_F_65537_8 + 0x000f),#0x8e
	mov	(_main_zero_F_65537_8 + 0x0010),#0x7f
	C$1_f_1.c$21$1_1$7 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1-f-1.c:21: while (1)
	mov	r6,#0x00
	mov	r7,#0x00
00104$:
	C$1_f_1.c$24$2_1$9 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1-f-1.c:24: if (P0_6 == 0)
	jb	_P0_6,00102$
	C$1_f_1.c$26$3_1$10 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1-f-1.c:26: delay(1000);
	mov	dptr,#0x03e8
	push	ar7
	push	ar6
	lcall	_delay
	...
	pop	ar7
	C$1_f_1.c$27$3_1$10 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1-f-1.c:27: i++;
	inc	r6
	cjne	r6,#0x00,00117$
	inc	r7
00117$:
00102$:
	C$1_f_1.c$29$2_1$9 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1-f-1.c:29: P2 = zero_F[i];
	mov	a,r6
	add	a,#_main_zero_F_65537_8
	mov	r1,a
	mov	_P2,@r1
	sjmp	00104$
	C$1_f_1.c$31$1_1$7 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1-f-1.c:31: }
	C$1_f_1.c$31$1_1$7 ==.
	XG$main$0$0 ==.
	ret
	.area CSEG    (CODE)
