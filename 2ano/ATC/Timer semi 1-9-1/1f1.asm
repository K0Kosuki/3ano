...
;--------------------------------------------------------
	.area	OSEG    (OVR,DATA)
L1f1.main$zero_F$1_1$3==.
_main_zero_F_65537_3:
	.ds 16
;--------------------------------------------------------
...
;zero_F                    Allocated with name '_main_zero_F_65537_3'
;------------------------------------------------------------
	G$main$0$0 ==.
	C$1f1.c$2$0_0$2 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1f1.c:2: void main(void)
;	-----------------------------------------
;	 function main
;	-----------------------------------------
_main:
	...
	ar0 = 0x00
	C$1f1.c$6$1_0$2 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1f1.c:6: PCA0MD = 0x00;
	mov	_PCA0MD,#0x00
	C$1f1.c$7$1_0$2 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1f1.c:7: XBR1 = 0x40;
	mov	_XBR1,#0x40
	C$1f1.c$8$2_0$3 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1f1.c:8: int i = 0;
	mov	r6,#0x00
	mov	r7,#0x00
	C$1f1.c$10$2_0$3 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1f1.c:10: unsigned char zero_F[] = {0xc0, 0xf9, 0xa4, 0xb0, 0x99, 0x92, 0x82, 0xf8, 0x80, 0x90, 0x88, 0x83, 0xc6, 0xa1, 0x86, 0x8e};
	mov	_main_zero_F_65537_3,#0xc0
	mov	(_main_zero_F_65537_3 + 0x0001),#0xf9
	mov	(_main_zero_F_65537_3 + 0x0002),#0xa4
	mov	(_main_zero_F_65537_3 + 0x0003),#0xb0
	mov	(_main_zero_F_65537_3 + 0x0004),#0x99
	mov	(_main_zero_F_65537_3 + 0x0005),#0x92
	mov	(_main_zero_F_65537_3 + 0x0006),#0x82
	mov	(_main_zero_F_65537_3 + 0x0007),#0xf8
	mov	(_main_zero_F_65537_3 + 0x0008),#0x80
	mov	(_main_zero_F_65537_3 + 0x0009),#0x90
	mov	(_main_zero_F_65537_3 + 0x000a),#0x88
	mov	(_main_zero_F_65537_3 + 0x000b),#0x83
	mov	(_main_zero_F_65537_3 + 0x000c),#0xc6
	mov	(_main_zero_F_65537_3 + 0x000d),#0xa1
	mov	(_main_zero_F_65537_3 + 0x000e),#0x86
	mov	(_main_zero_F_65537_3 + 0x000f),#0x8e
	C$1f1.c$12$1_1$3 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1f1.c:12: P2 = 0xC0;
	mov	_P2,#0xc0
	C$1f1.c$14$1_1$3 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1f1.c:14: while (1)
00116$:
	C$1f1.c$16$2_1$4 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1f1.c:16: P2 = zero_F[i];
	mov	a,r6
	add	a,#_main_zero_F_65537_3
	mov	r1,a
	mov	_P2,@r1
	C$1f1.c$17$2_1$4 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1f1.c:17: if (P0_7 == 0)
	jb	_P0_7,00107$
	C$1f1.c$19$3_1$5 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1f1.c:19: while (P0_7 == 0)
00101$:
	jnb	_P0_7,00101$
	C$1f1.c$21$3_1$5 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1f1.c:21: i++;
	inc	r6
	cjne	r6,#0x00,00150$
	inc	r7
00150$:
	C$1f1.c$23$3_1$5 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1f1.c:23: if (i > 15)
	clr	c
	mov	a,#0x0f
	subb	a,r6
	mov	a,#(0x00 ^ 0x80)
	...
	jnc	00107$
	C$1f1.c$25$4_1$6 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1f1.c:25: i = 0;
	mov	r6,#0x00
	mov	r7,#0x00
00107$:
	C$1f1.c$31$2_1$4 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1f1.c:31: if (P0_6 == 0)
	jb	_P0_6,00116$
	C$1f1.c$33$3_1$7 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1f1.c:33: while (P0_6 == 0)
00108$:
	jnb	_P0_6,00108$
	C$1f1.c$35$3_1$7 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1f1.c:35: i--;
	dec	r6
	cjne	r6,#0xff,00154$
	dec	r7
00154$:
	C$1f1.c$37$3_1$7 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1f1.c:37: if (i < 0)
	mov	a,r7
	jnb	acc.7,00116$
	C$1f1.c$40$4_1$8 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1f1.c:40: i = 15;
	mov	r6,#0x0f
	mov	r7,#0x00
	sjmp	00116$
	C$1f1.c$45$1_1$2 ==.
;	C:\2ano\ATC\Timer semi 1-9-1\1f1.c:45: }
	C$1f1.c$45$1_1$2 ==.
	XG$main$0$0 ==.
	ret
	.area CSEG    (CODE)
